...
export class ElementFragment extends Fragment {
   ...
   *
   * 供給同士は後勝ちです（仕様「反映待ちの間に起きた変化」）。古い供給が後から届いた供給を上書きしない
   ...
   * この Promise を待ってから改めて反映します（後勝ち、仕様「反映待ちの間に起きた変化」）。捨てるのは
   ...
   * 「最後に供給された値が残る」（仕様「反映待ちの間に起きた変化」）が崩れるため、適用してはいけません。
   *
  ...
  private setAttributeInternal(
    ...
    if (pendingWrite !== null) {
      ...
      // （後勝ち、仕様「反映待ちの間に起きた変化」）。捨てると、最後に供給された値が属性へ載らないまま
